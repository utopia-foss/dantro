...
``dantro`` is meant to be *integrated* into projects and be used to set up such a data processing pipeline, customized to the needs of the project.
...
.. hint::
    ...
    An introductory text about the **motivation and scope of dantro** can be found in `in the Journal of Open Source Software <https://doi.org/10.21105/joss.02316>`_.
