...
A copy of the [GNU General Public License Version 3][GPLv3], and the [GNU Lesser General Public License Version 3][LGPLv3] extending it, is distributed with the source code of this program; see [`LICENSE`](LICENSE) and [`LICENSE.LESSER`](LICENSE.LESSER), respectively.
