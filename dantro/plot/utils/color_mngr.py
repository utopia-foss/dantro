        ...
        Args:
            cmap (Union[str, dict, matplotlib.colors.Colormap], optional):
                ...
                ``from_values`` (Union[dict, list], optional):
                    ...
                    shifted depending on ``vmin`` and ``vmax``.
                ...
                ``labels_and_colors`` (dict, optional):
                    ...
                    The label positions and bounds are inferred and are
                    affected by ``vmin`` and ``vmax``.
                    These may also be given implicitly via ``**kwargs``, but
        ...
        **kwargs,
        ...
        Args:
            ...
            continuous (bool, optional): Whether to create a continuous or a
                discrete colormap.
            from_values (dict, optional): The values from which to create the
                colormap.
